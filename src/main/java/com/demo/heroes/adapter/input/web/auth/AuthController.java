...
import com.demo.heroes.adapter.input.web.auth.request.JwtRestRequest;
import com.demo.heroes.adapter.input.web.auth.response.JwtRestResponse;
import com.demo.heroes.application.security.JwtToken;
import com.demo.heroes.domain.port.input.GetUserInformationUseCase;
import com.demo.heroes.util.AuthenticateUtil;
...
public class AuthController {
  ...
  public Single<ResponseEntity<JwtRestResponse>> createAuthenticationToken(
    ...
    return getUserInformationUseCase.loadUserByUsername(authenticationRequest.getUsername())
             .map(userDetails -> {
